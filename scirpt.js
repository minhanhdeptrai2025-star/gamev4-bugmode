...
switch (args[0]) {
  ...
  case "god":
    ...
    terminalOutput.innerHTML = "> GOD MODE ON";
    break;

  case "gold":
    coins = 999999;
    terminalOutput.innerHTML = "> INFINITE GOLD";
    break;

  case "wave":
    if (args[1]) {
      wave = parseInt(args[1]);
      terminalOutput.innerHTML = "> WAVE SET TO " + wave;
    } else {
      terminalOutput.innerHTML = "> USAGE: -wave 10";
    }
    break;

  case "killall":
    if (window.enemies && Array.isArray(enemies)) {
      enemies.length = 0;
      terminalOutput.innerHTML = "> ALL ENEMIES KILLED";
    } else {
      terminalOutput.innerHTML = "> ENEMY ARRAY NOT FOUND";
    }
    break;
